...
public class ReaderCardDao {
    ...
    private final static String ADD_READERCARD_SQL="INSERT INTO reader_card (reader_id,name,passwd,card_state) values ( '"+ThreadLocalRandom.current().nextInt(1000000)+"' ,'111111','1', ?)";
    ...
    public int addReaderCard(ReaderInfo readerInfo){
        ...
        return jdbcTemplate.update(ADD_READERCARD_SQL,new Object[]{name});
    }
