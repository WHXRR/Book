...
public class LendDao {
    ...
    private final static String BOOK_LEND_SQL_ONE="INSERT INTO lend_list (sernum,book_id,reader_id,lend_date) VALUES ('"+ ThreadLocalRandom.current().nextInt(1000000)+"' ,? , ? , ? )";
    ...
    public int bookLendOne(long bookId,int readerId){
        return  jdbcTemplate.update(BOOK_LEND_SQL_ONE,new Object[]{bookId,readerId,new Date()});
    }
