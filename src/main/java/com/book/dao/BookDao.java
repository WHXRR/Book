...
public class BookDao {
    ...
    private final static String ADD_BOOK_SQL="INSERT INTO book_info VALUES("+ ThreadLocalRandom.current().nextInt(10000)+" ,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private final static String QUERY_BOOK_SQL="SELECT   a.*,b.class_name  FROM book_info a left join class_info b on a.class_id = b.class_id   WHERE name like ?   ";
    private final static String QUERY_BOOK_SQL1="SELECT  a.*,b.class_name  FROM book_info a left join class_info b on a.class_id = b.class_id  WHERE  name like  '%%'  ";
    //查询匹配图书的个数
    private final static String MATCH_BOOK_SQL="SELECT count(*) FROM book_info WHERE book_id like ?  or name like ?  ";
    //根据书号查询图书
    private final static String GET_BOOK_SQL="SELECT a.*,b.class_name FROM book_info a left join class_info b on a.class_id = b.class_id where book_id = ? ";
    ...
    public ArrayList<Book> queryBook(String sw){
        ...
        jdbcTemplate.query(QUERY_BOOK_SQL, new Object[]{swcx},new RowCallbackHandler() {
            public void processRow(ResultSet resultSet) throws SQLException {
                ...
                while (resultSet.next()){
                    ...
                    book.setClassName(resultSet.getString("class_name"));
